<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("response");
					i++;
...
<div id="container">
	<div id="header">
		New Process Instance: /process/src/main/resources.reproducer-process
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="response" type="text" class="textbox" id="response" value="" />
                            		</div>
